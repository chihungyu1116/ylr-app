...
exports["default"] = _react2["default"].createElement(
  _reactRouter.Route,
  { path: "/", handler: _componentsAppController2["default"] },
  _react2["default"].createElement(_reactRouter.DefaultRoute, { handler: _componentsHomeController2["default"] }),
  _react2["default"].createElement(_reactRouter.Route, { path: "about", handler: _componentsAboutController2["default"] }),
  _react2["default"].createElement(_reactRouter.Route, { path: "user", handler: _componentsUserController2["default"] }),
  _react2["default"].createElement(_reactRouter.Route, { path: "faq", handler: _componentsFAQController2["default"] }),
  _react2["default"].createElement(_reactRouter.Route, { path: "forum", handler: _componentsForumController2["default"] })
);
